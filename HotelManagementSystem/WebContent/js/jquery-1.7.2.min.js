...
(function(a, b) {
    ...
    f = function() {
        ...
        e.extend({
            ...
            parseXML: function(c) {
                ...
                var d, f;
                try {
                    a.DOMParser ? (f = new DOMParser, d = f.parseFromString(c, "text/file")) : (d = new ActiveXObject("Microsoft.XMLDOM"), d.async = "false", d.loadXML(c))
                } catch(g) {
                    d = b
    ...
    f.extend({
        ...
        ajaxSettings: {
            ...
            async: !0,
            accepts: {
                xml: "application/file, text/file",
                html: "text/html",
                text: "text/plain",
